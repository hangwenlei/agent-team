...
//
// ⚠️ Ruling 21 修了这段注释的括号：它原来写的是「at-backend / at-frontend /
...
// 当成现状读的假话**，按本分支已经定过的同一条理由（Ruling 4/6/20）改掉：这里不再
...
// 静默的，其余测试无一会发现。
//
// ⚠️ **Ruling 24（2026-09-20）：上面这句话对本测试遍历的三份正文，认知状态不一样，
// 分开说。**
//
...
// 长得一模一样——都是全绿）。
//
// ⚠️ **Ruling 21（M2b Task 5 实测，2026-09-20）：这一段原来的「后果」是假话，已改写。**
//
...
// （agents/at-pm.md 那一侧的对策是 Ruling 22：把「白名单不是你的边」这句**否定**
...
// （docs/11 §5.13、Ruling 13、Ruling 15）。
//
...
// ⚠️ **Ruling 22（M2b Task 5，2026-09-20）：把「白名单不是你的边」这句否定钉进
// agents/at-pm.md 的正文。**
//
